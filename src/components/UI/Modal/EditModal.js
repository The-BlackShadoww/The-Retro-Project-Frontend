...
// const EditModal = ({ modal, onModal, message, children, title }) => {
//     return (
//         <div className="w-screen h-screen fixed top-0 left-0 flex justify-center items-center bg-black/20 z-[100]">
//             <div className="Poppins bg-white text-black h-auto max-w-[500px] w-full mx-2 relative px-10 py-12 rounded-3xl border overflow-hidden transition-all duration-500">
//                 <span
//                     onClick={onModal}
//                     className="absolute top-[48px] right-[40px] cursor-pointer border border-black rounded-full p-1"
//                 >
//                     <CloseIcon />
//                 </span>
//                 <h1 className="text-3xl font-semibold">{title}</h1>
